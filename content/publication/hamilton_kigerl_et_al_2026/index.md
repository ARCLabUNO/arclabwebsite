...
summary = "Criminal history is a well-established predictor of future offending, yet recidivism risk declines with time. Research has struggled to reconcile this tension as criminal history is often treated as a static indicator of risk, while desistance is commonly inferred rather than directly modeled. Using a five-state population of criminal charges spanning forty years (N = 16,594,838; person-year observations = 746,396,524), we model recidivism prediction decay following a prior charge."
...
tags = ["risk-needs-assessment", "criminological theory", "recidivism"]
...
links = [{name = "DOI", url="http://doi.org/10.1111/1745-9125.70069", icon = "unlock-alt", icon_pack = "fas"}, {name = "Data Explorer", url = "/explorers/criminal-history-expiration-date/", icon = "chart-line", icon_pack = "fas"}, {name = "Replication Materials", url = "https://github.com/ARCLabUNO/criminal-history-expiration-date", icon = "github", icon_pack = "fab"}, {name = "Flyer", url = "/criminal-history-expiration-date-flyer.pdf", icon = "file-pdf", icon_pack = "fas"},]
