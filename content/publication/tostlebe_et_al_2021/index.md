...
# Authors
authors = ["tostlebe", "David Pyrooz", "Richard Rogers", "Ryan Masters"]
...
publishdate = 2021-01-02T10:00:00Z
  
# Project summary to display on homepage.
summary = "The National Death Index (NDI), a comprehensive and well-established database compiled by the National Center for Health Statistics, is an untapped source of homicide data that offers identifiable linkages to other data sources while retaining national coverage."
...
links = [{name = "Preprint", url="https://www.researchgate.net/publication/341811646_The_National_Death_Index_as_a_Source_of_Homicide_Data_A_Methodological_Exposition_of_Promises_and_Pitfalls_for_Criminologists", icon = "unlock-alt", icon_pack = "fas"}, {name = "DOI", url="https://doi.org/10.1177/1088767920924450"}]
