...
# Authors
authors = ["tostlebe", "Selena Munoz-Jones"]
...
summary = "In this chapter, we document the landscape of healthcare in corrections."
...
tags = ["institutional corrections", "health", "deaths in custody"]
...
links = [{name = "Preprint", url="https://www.researchgate.net/publication/377467664_Public_Accessibility_of_Healthcare_Information_in_Prison_A_Review_of_US_State_Department_of_Corrections_Websites", icon = "unlock-alt", icon_pack = "fas"}]
