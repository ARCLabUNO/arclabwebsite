...
# Authors
authors = ["admin", "kigerl", "allenflores", "kobie", "ursino"]
  
# Publication
publication = "*Nebraska Center for Justice Research*"
...
summary = "In response to growing concerns among stakeholders and policy makers regarding crowding in Nebraska correctional facilities, the Nebraska Department of Correctional Services (NDCS) partnered with the Nebraska Center for Justice Research (NCJR) to examine causes and solutions."
...
links = [{name = "Technical Report", url="technicalreport.pdf", icon = "unlock-alt", icon_pack = "fas"}, {name = "Research Brief", url="researchbrief.pdf", icon = "unlock-alt", icon_pack = "fas"}]
